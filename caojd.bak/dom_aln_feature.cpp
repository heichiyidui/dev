    ...
    for (size_t l =0; l<dom_ids.size();l++){
        ...
        for (size_t i=4;i<dom_len;i++){
            for (size_t j=i+5;j<dom_len;j++){
                ...
                for (size_t m=0;m<aln_len;m++){
                    for (size_t n=m+1;n<aln_len;n++){
                        cao_score+=cao[aln[i][m]*20+aln[j][m]] \
                                      [aln[i][n]*20+aln[j][n]];
                    }
                }
        ...
        for (size_t i=4;i<dom_len;i++){
            for (size_t j=i+5;j<dom_len;j++){
                ...
                for (size_t iter=0;iter<100;iter++){
                    ...
                    for (size_t m=0;m<aln_len;m++){
                        for (size_t n=m+1;n<aln_len;n++){
                            per_cao_score+=cao[aln[i][m]*20+aln[j][m]] \
                                              [aln[i][n]*20+aln[j][n]];
                        }
                    }
        ...
        for (size_t i=0;i<mat_len ; i++){
            ...
            float norm_score1,norm_score2,norm_score3,norm_score4;
            ...
            cout<<norm_score1<<' '<<norm_score2<<' '
                <<norm_score3<<' '<<norm_score4<<' '<<cont_map[i]<<'\n';
        }
        // break;             
    }
    return(0);
